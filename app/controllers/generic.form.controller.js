(function(){
    angular
    .module('myApp')
    .controller('GenericFormController', ['GenericFormService', 'ConnectService', '$location','$scope', 'DynamicStaticDataService', '$rootScope', 'RequestFormatter',
    GenericFormController
]);

function GenericFormController(GenericFormService, ConnectService, $location, $scope, DynamicStaticDataService, $rootScope, RequestFormatter) {
   ...
   // };
    ...
    vm.onsubmit = function ($event) {
        // RATHER THAN MESSING WITH THE FORMMODEL ITSELF, I SHOULD
        // USE IT AS AN INPUT FOR A REAL REQUEST!!!!!!
        ...
        //     vm.formmodel.stop_overview.barcodeid = vm.formmodel.barcodeid.map( function(item) { return item.id } )
        //     // vm.formmodel.barcodeid = ''
        //     var request = {}
        //
        //     return
        //
        ...
        // }
        GenericFormService.showconfirmationdialog($event, RequestFormatter.formatRequest(vm.formmodel), vm.cancel);
    }
